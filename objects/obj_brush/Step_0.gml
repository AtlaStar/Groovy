...
/***********************
	All of the following was solely used for inline testing rather than properly compartmentalized
	and should be deleted following code cleanup.
*/
#region to_delete
...
physics_particle_group_begin(flags, groupflags, x, y, 0, 0, 0, 0, col, 1, 1, 1);
physics_particle_group_circle(8);
